...
<div class="<?php echo esc_html($col_class);?> listing_wrapper" data-org="<?php echo esc_html($col_org);?>" data-listid="<?php echo intval($post->ID);?>" > 
    <div class="property_listing  <?php if($wpestate_uset_unit==1) print 'property_listing_custom_design' ?> " >
...
//customize end
            ...
            <?php
              $listingurl=get_post_meta($post->ID, 'property_size', true) ;
          
            ?>

            <h4><a href="<?php echo $listingurl; ?>" target="_blank">                
                <?php
//                    echo ($link);
//                    echo esc_url($link);
            ...
            <?php if ($align_class=='the_list_view') {?>
                <div class="listing_details the_list_view" style="display:block;">
                    <?php   
// parmalink customize
//               $listingurl=get_post_meta($post->ID, 'property_Before Price Label', true) ;
//echo  $listingurl.'....OK...';
                        echo wpestate_strip_excerpt_by_char(get_the_excerpt(),220,$post->ID);
                    ?>
            ...
            ?>
                ...
                <div class="listing_details the_list_view">
                    <?php
                        echo  wpestate_strip_excerpt_by_char(get_the_excerpt(),115,$listingurl);
                    ?>
                </div>
            <?php } ?>   
